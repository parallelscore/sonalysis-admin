...
const Analytics = ({ history }) => {
  ...
  const coachDetails = allUploadData.filter((item)=>item._id===coach_id)[0]
  ...
  return (
    <div className="all-video">
      ...
      <div className="top-coach">
        <div className="d-flex mt-5 mb-5 mr-3 back " onClick={() => history.goBack()}>
        ...
        <button className="delete">Delete</button> <Link to="/app/clubs/create-club"><button className="new-btn">Create new club</button></Link>
      </div>
