...
const CreateClub = ({ handleChangeStep, history }) => {
    ...
    <div className="step-two">
      ...
      <div className="col-lg-6 table-row d-flex align-items-center p-3 mt-3">
        <div className="col-8 d-flex align-items-center">
          ...
          <div className="pl-5 ml-5">Manchester United vs Chelsea</div>
        </div>
        <div className="col-2" onClick={()=>setShowVideoModal(true)}>View</div>
      ...
      <div className=" form col-lg-8 mt-5">
        <div className="form-group  mt-5 ">
          ...
          <button className="completete-player px-3">View CSV file</button>
        </div>
      </div>
