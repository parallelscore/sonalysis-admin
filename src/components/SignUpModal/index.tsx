                ...
                <div className='signup col-lg-9 mx-auto'>
                    <div className='signup-left col-5 d-none d-lg-flex'>
                        ...
                        <div className='signup-left-text '>
                            ...
                            elit. Ut purus rhoncus lectus posuere elit et. Odio
                            sapien cras molestie viverra vestibulum. Eros
                            pulvinar lacinia fermentum tincidunt fames etiam
                            lorem.
                        </div>
                    </div>
                    <div className='signup-right col-lg-7 p-5'>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className='get-start mt-2'>
                                ...
                                <span onClick={handleLoginOpenModal}>
                                    Login
                                </span>
                            </div>
                        </form>
